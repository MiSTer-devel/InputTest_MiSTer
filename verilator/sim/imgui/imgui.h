...
namespace ImGui
{
    ...
    IMGUI_API void          SetWindowFontScale(float vga_scale);                                            // set font scale. Adjust IO.FontGlobalScale if you want to scale all windows. This is an old API! For correct scaling, prefer to reload font + rebuild ImFontAtlas + call style.ScaleAllSizes().
...
struct ImFont
{
    ...
    IMGUI_API const char*       CalcWordWrapPositionA(float vga_scale, const char* text, const char* text_end, float wrap_width) const;
